...
- 每回合結束後方塊下降一格並新增一排。
- 收集青色 `+1`，下一回合會多一顆球。
- 新排有機會隨機出現金幣，集滿 10 枚可在主畫面的 Ball Lab 抽取尚未解鎖的永久球款。
- 球款擴充為十種，包含標準圓球、迷你球、三角球、彗星、六角球、像素方球、泰坦大球、幽影球、彩虹球與星芒球。
- 迷你球會顯示在雷射特效上方；三角、六角、方形與星形球發射時會以隨機方向及速度持續自轉。
- 任一方塊抵達底線上方一格的警戒區時遊戲結束；失敗後可花費 10 枚金幣清除最下面三層並復活。
...
目前版本：`1.14.0 (18)`。專案使用獨立 bundle identifier，以避免側載工具沿用舊 App 容器；每次功能更新都會同步提高 App 的版本或 build number。
